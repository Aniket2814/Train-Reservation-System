...
public class TrainServiceImpl implements TrainService {
    ...
    public String addTrain(TrainBean train) {
        ...
        try {
            ...
            java.util.Date utilDate = inputFormat.parse(train.getDate());
            ...
            ps.close();
        } catch (SQLException | ParseException | TrainException e) {
            responseCode += " : " + ((Throwable) e).getMessage();
        }
        return responseCode;
    }
	...
	public String updateTrain(TrainBean train) {
	    ...
	    try {
	        ...
	        ps.setLong(6, train.getTr_no()); // Corrected index for TR_NO parameter
